    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-brand-orange/10 to-brand-blue/10 rounded-2xl p-8">
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="w-14 h-14 rounded-xl bg-brand-blue/10 text-brand-blue flex items-center justify-center mx-auto mb-3">
                    {stat.icon}
                  </div>
                  <p className="text-2xl font-bold text-brand-blue">{stat.number}</p>
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-brand-blue mb-4">What Drives Us</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <h3 className="font-semibold text-brand-blue text-lg mb-3">{item.title}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-brand-blue mb-4">Powered by Cutting-Edge AI</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 text-center">
              <div className="w-12 h-12 rounded-lg bg-brand-blue/10 text-brand-blue flex items-center justify-center mx-auto mb-3">
                {tech.icon}
              </div>
              <h3 className="font-semibold text-brand-blue mb-1">{tech.title}</h3>
      ...
      <div className="bg-gradient-to-br from-brand-blue to-brand-blue-dark rounded-none py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`${APP_URL}/auth`}
              className="inline-flex items-center gap-2 px-8 py-4 bg-brand-orange hover:bg-brand-orange-dark text-white font-semibold rounded-xl transition-all shadow-lg"
            >
