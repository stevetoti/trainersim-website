      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-xs">
              AI-powered training simulations that help professionals master high-stakes conversations and close more deals.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} TrainerSim by Pacific Wave Digital. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
            Built with ❤️ for professionals who want to excel.
          </p>
        </div>
      </div>
    </footer>
