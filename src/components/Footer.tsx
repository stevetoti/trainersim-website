          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <form className="flex gap-2 w-full md:w-auto" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="px-4 py-2 rounded-lg bg-blue-800/50 border border-blue-400/30 text-white placeholder:text-blue-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-orange w-full md:w-64"
              />
              <button
                type="submit"
                className="px-6 py-2 bg-brand-orange hover:bg-brand-orange-dark text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2 shrink-0"
              >
